    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3>Edit Product: <?php echo e($product->name); ?></h3>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <img id="imagePreview" 
                     src="<?php echo e($product->image_url ?? 'https://via.placeholder.com/300'); ?>" 
                     class="img-fluid rounded" 
                     style="max-height: 200px; object-fit: cover;">
                <?php if($product->cloudinary_public_id): ?>
                    <p class="mt-2 text-muted"><small>Cloudinary ID: <?php echo e($product->cloudinary_public_id); ?></small></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                <p><strong>Created:</strong> <?php echo e($product->created_at->format('d M Y')); ?></p>
                <p><strong>Last Updated:</strong> <?php echo e($product->updated_at->format('d M Y')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mini-store\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>